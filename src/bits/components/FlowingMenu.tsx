...
function MenuItem({ link, text, image }) {
  ...
  const repeatedMarqueeContent = Array.from({ length: 4 }).map((_, idx) => (
    <React.Fragment key={idx}>
      <span className="text-[#060606] uppercase font-normal text-[4vh] whitespace-nowrap leading-[1.2] p-[1vh_1vw_0]">
        {text}
      </span>
      <div
        className="w-[200px] h-[17vh] my-[2em] mx-[2vw] p-[1em_0] rounded-[20px] bg-cover bg-center"
